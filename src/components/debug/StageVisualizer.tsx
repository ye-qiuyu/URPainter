  ...
  return (
    <div className={`flex flex-col items-center p-4 rounded-lg border border-gray-200 ${className}`}>
      ...
      <div className="flex items-center justify-between w-full mb-4">
        {(['A', 'B1', 'B2', 'C1', 'C2', 'D'] as ConversationStage[]).map((stage, index) => {
      ...
      <div className="mt-4 text-sm text-gray-600 w-full">
        ...
        <ul className="list-disc pl-5">
          ...
          <li>B1 - 绘制主角(首次)：帮助儿童完成画面主角的首次创作，收集主角特征</li>
          <li>B2 - 绘制主角(细节)：帮助儿童完成画面主角的细节创作，收集主角特征</li>
          <li>C1 - 联想新元素：通过联想扩展创意和元素，丰富画面内容</li>
          <li>C2 - 绘制支持元素：添加背景、环境和辅助元素，完善场景</li>
          <li>D - 完成创作：帮助儿童总结创作内容，完成作品命名</li>
        </ul>
      </div>
    </div>
  );
